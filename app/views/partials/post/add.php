                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <label class="control-label" for="catagory">Catagory <span class="text-danger">*</span></label>
                                                </div>
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        
                                                        <select required=""  id="ctrl-catagory" name="catagory"  placeholder="Select a value ..."    class="custom-select" >
                                                            <option value="">Select a value ...</option>
                                                            
                                                            <?php 
                                                            $catagory_options = $comp_model -> post_catagory_option_list();
                                                            if(!empty($catagory_options)){
                                                            foreach($catagory_options as $arr){
                                                            $val = array_values($arr);
                                                            $selected = $this->set_field_selected('catagory',$val[0], '');
                                                            ?>
